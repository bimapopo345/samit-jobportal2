      ...
      },
      {
        ...
        headers: [
          ...
          },
          {
            ...
            value: `default-src 'self'; img-src 'self' data: blob: https://*.supabase.co https://api.dicebear.com https://images.unsplash.com; connect-src 'self' https://*.supabase.co https://supabase.kerjadijepang.co.id; font-src 'self' data: https://fonts.gstatic.com; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com; script-src 'self' 'unsafe-eval' 'unsafe-inline'; frame-src 'self'; media-src 'self' blob:`,
          },
        ],
      },
    ];
